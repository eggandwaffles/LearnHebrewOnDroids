...
<Image source={require("../assets/images/UnderConstructionBanner.png")} style={{ width: 250, height: 25}} />
  ...
  <View style={{flexDirection: 'column', flex: 2, alignContent: 'center', justifyContent: 'center'}}>
    ...
    <View style={styles.blueListItem}><HebrewText style={styles.listText}>Hebrew</HebrewText><HebrewText style={styles.listText}>Time Remaining</HebrewText><HebrewText style={styles.listText}>Correct?</HebrewText><HebrewText style={styles.listText}>guesses</HebrewText></View>
