...
export default function ProgressScreen( { navigation } ) {
  ...
  var  sampleData = [{timeRemaining: "Time remaining", correctAnswer: true, guesses: "Guesses", depiction: "Word", questionType: "translit" }]    
  var DATA =  sampleData.concat(getProgressData())
