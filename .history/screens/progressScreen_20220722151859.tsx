        ...
        if (item.questionType == "translit") {
            ...
            return (
                <View style={{backgroundColor: palette.interactable, marginBottom: 10}}>
                    <View style={styles.blueListItem}><HebrewText style={styles.listText}>{item.depiction + " | " + item.timeRemaining + "s | " + (item.correctAnswer ? `\u{1F44D}` : `\u{1F44E}`) + " | " + item.guesses}</HebrewText></View>
                </View>
            )
        } else {
