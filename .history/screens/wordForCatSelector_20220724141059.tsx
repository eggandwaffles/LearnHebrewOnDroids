...
const wordForCatSelector = observer(({ route, navigation }) => {
    ...
    if (california.arg.length>wordData.length) {
        console.error(`Too much California: California exceeded by ${california.arg.length - wordData.length}`)
    } else {
    ...
    try {
        ...
        console.log(`item initialization complete. California is now at ${california.arg.length}`)
